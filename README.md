...
COCA.getOC(
  ...
  dosage.ctrl = c(A = log(750), B = 0), dosage.singleA = 0, dosage.singleB = log(1500), 
  dosage.comb = list(A = c(log(300), log(75)), B = c(log(1500), log(1500))), 
  tox.SOC = 0.246, eff.SOC = 0.072, tox.B = 0.109, eff.B = 0.106, 
  tox.AB = c(0.176, 0.146), eff.AB.s1 = c(0.240, 0.095), eff.AB.s2 = c(0.240, 0.095), 
...
COCA.getOC(
  ...
  dosage.comb = list(A = c(log(300), log(75)), B = c(log(1500), log(1500))), 
  tox.SOC = 0.246, eff.SOC = 0.072, tox.B = 0.109, eff.B = 0.106, 
  tox.AB = c(0.176, 0.146), eff.AB.s1 = (c(0.240, 0.095) + 0.05), eff.AB.s2 = c(0.240, 0.095), 
  tox.isomat = matrix(c(2, 1), byrow = T, nrow = 1), 
  tox.upper = 0.35, eff.lower = 0.07, Cs = 0.80, C.f1 = 0.90, C.f2 = 0.90, 
  utility.score = c(0, 40, 60, 100), rho = 0.2, n.simu = 5000
  )
