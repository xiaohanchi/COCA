...
> **NOTE:**
The above example is a simplified version with fewer prior samples and simulations to facilitate user testing. Please note that Monte Carlo error may be non-negligible if the number of simulations is not sufficiently large. \
