...
So far, we have determined the optimal design parameters: `n.stage2 = 38`, `Ce = 0.7710`, and `c0 = 0.84`. To assess the design performance, we still need to specify the true efficacy and toxicity rates. We used the observed trial outcomes to : The toxicity rates in the four arms (T vs. D vs. T300+D vs. T75+D) were 24.6\%, 10.9\%, 17.6\%, and 14.6\%, and efficacy rates were 7.2\%, 10.6\%, 24.0\%, and 9.5\%, respectively. Therefore:
```{r}
tox.SOC = 0.246
tox.B = 0.109
