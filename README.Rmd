...
display.output
```
In stage 1, we have an 83.54\% chance of selecting the correct combination dose as the OBD, with an average sample size of 43.79 patients. In stage 2, the power of our design is 78.10\%, the GP is 74.19\%, the SR is 69.48\%, and the OSR is 67.53\%, with an average sample size of 104.60 patients. In total, the trial requires an average of 148.39 patients (43.79 in stage 1 and 104.60 in stage 2).
