...
`n.simu` is set to 100 for illustration. For more accurate calibration, consider using a larger value, such as 10000, though this may require additional computation time. If the power does not reach the target, increase `n.stage2` and repeat the process.
