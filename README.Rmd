...
For more accurate calibration, consider increasing `prior.sample` to $10^6$ and setting `n.simu` to $10^4$, though this may require additional computation time. If the power or success rate do not reach the target, increase `n.stage2` and repeat the process.
